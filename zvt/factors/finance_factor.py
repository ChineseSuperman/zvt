...
from zvt.domain import FinanceFactor, EntityType, IntervalLevel, Provider
...
class FinanceGrowthFactor(ScoreFactor):
    ...
    def __init__(self,
        ...
        super().__init__(FinanceFactor, security_list, entity_type, exchanges, codes, the_timestamp, start_timestamp,
