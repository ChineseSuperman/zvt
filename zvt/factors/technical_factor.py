...
class TechnicalFactor(FilterFactor):
    ...
    def __init__(self,
        ...
        super().__init__(self.data_schema, security_list, entity_type, exchanges, codes, the_timestamp,
...
class CrossMaFactor(TechnicalFactor):
    def __init__(self,
        ...
        super().__init__(security_list, entity_type, exchanges, codes, the_timestamp, start_timestamp, end_timestamp,
...
class BullFactor(TechnicalFactor):
    def __init__(self, security_list: List[str] = None, entity_type: Union[str, EntityType] = EntityType.stock,
                 ...
                 provider: Union[str, Provider] = 'joinquant', level: IntervalLevel = IntervalLevel.LEVEL_1DAY,
                 real_time: bool = False, refresh_interval: int = 10, category_field: str = 'entity_id',
