...
from zvt.domain import IntervalLevel, EntityType, Provider, Stock1DKdata, StoreCategory, Stock
...
if __name__ == '__main__':
    ...
    ChinaStockDayKdataRecorder(level=IntervalLevel.LEVEL_1DAY, codes=['000338']).run()
