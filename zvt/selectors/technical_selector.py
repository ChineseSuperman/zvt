...
class TechnicalSelector(TargetSelector):
    def __init__(self, security_list=None, entity_type=EntityType.stock, exchanges=['sh', 'sz'], codes=None,
    ...
    def init_factors(self, security_list, entity_type, exchanges, codes, the_timestamp, start_timestamp,
                     end_timestamp):
        bull_factor = BullFactor(security_list=security_list, entity_type=entity_type, exchanges=exchanges,
