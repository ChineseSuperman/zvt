...
from zvt.domain import EntityType, IntervalLevel, Provider, business, get_db_session, StoreCategory
...
class Trader(Constructor):
    ...
    def __init__(self,
        ...
        if self.security_list:
            entity_type, exchange, code = decode_entity_id(self.security_list[0])
        ...
        self.init_selectors(security_list=security_list, entity_type=self.entity_type, exchanges=self.exchanges,
    ...
    def on_start(self):
        ...
        trader_domain = business.Trader(id=self.trader_name, timestamp=self.start_timestamp,
                                        ...
                                        entity_type=security_list, exchanges=exchanges, codes=codes,
    ...
    def init_selectors(self, security_list, entity_type, exchanges, codes, start_timestamp, end_timestamp):
        """
